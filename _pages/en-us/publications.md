...
vol. 29, no. 1, pp. 200-204, Jan. 2025. 
  <span class="paper-info">(JCR Q2, IF = 4.4, 🏆 ESI Highly Cited Paper, Popular Article of the Year TOP2) </span>
...
<span class="journal-name">IEEE Transactions on Vehicular Technology</span>, 
2025. 
  <span class="paper-info">(Co first author, main supervisor, JCR Q1, IF = 7.1) </span>
...
vol. 30, pp. 1905-1909, 2026. 
  <span class="paper-info">(Co first author, main supervisor, JCR Q2, IF = 4.4, 最受欢迎论文TOP 50) </span>
...
<span class="journal-name">IEEE Wireless Communications Letters</span>, 
2026. 
  <span class="paper-info">(Co first author, main supervisor, JCR Q1, IF = 5.5) </span>
...
<span class="journal-name">IEEE Wireless Communications Letters</span>, 
2026. 
  <span class="paper-info">(Main supervisor, JCR Q1, IF = 5.5)</span>
...
<span class="journal-name">IEEE Transactions on Wireless Communications</span>, 
2025. 
  <span class="paper-info">(JCR Q1, IF = 10.7, Major Revision)</span>
</li>
...
<span class="journal-name">IEEE Internet of Things Journal</span>, 
2026. 
  <span class="paper-info">(Main supervisor, JCR Q1, IF = 8.33, Major Revision)</span>
</li>
...
<span class="paper-info">(Co first author, main supervisor, IEEE ComSoc Flagship Conference)</span>
...
<span class="paper-info">(Main supervisor)</span> 
